const RECENT_DOCS = [
  { name: "INV-2024-01568.pdf", type: "Invoice",  typeColor: "border border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-400", status: "Posted",  statusColor: "text-green-600 dark:text-green-400" },
  { name: "GRN-2024-00892.pdf", type: "GRN",      typeColor: "border border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-400", status: "Posted",  statusColor: "text-green-600 dark:text-green-400" },
  { name: "CTR-2024-00045.pdf", type: "Contract", typeColor: "border border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-400", status: "Active",  statusColor: "text-blue-600 dark:text-blue-400"  },
  { name: "INV-2024-01501.pdf", type: "Invoice",  typeColor: "border border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-400", status: "Pending", statusColor: "text-amber-600 dark:text-amber-400" },
];
          ...
          <div className="space-y-2">
            {RECENT_DOCS.map(doc => (
              <div key={doc.name} className="flex items-center gap-3 p-2 rounded-lg border border-slate-100 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                ...
                <span className={`text-[10px] font-semibold px-2 py-[2px] rounded-full ${doc.typeColor}`}>{doc.type}</span>
        ...
        <div className="bg-white dark:bg-[#1A2433] border border-slate-200 dark:border-slate-700 rounded-xl p-4">
          ...
          <div className="flex items-center gap-3 p-3 border border-slate-100 dark:border-slate-700 rounded-xl">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-[12px] font-bold text-slate-800 dark:text-slate-200">INV-2024-01501.pdf</div>
              <div className="text-[11px] text-slate-400">PQR Ltd · ₹67,000</div>
            </div>
            <button
